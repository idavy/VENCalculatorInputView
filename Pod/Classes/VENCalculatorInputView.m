...
//		[self setOperationButtonBorderColor:[UIColor colorWithRed:172/255.0f green:174/255.0f blue:177/255.0f alpha:1]];
		...
		[self setNumberButtonBackgroundColor:[UIColor colorWithRed:232/255.0f green:232/255.0f blue:232/255.0f alpha:1]];
		[self setNumberButtonBorderColor:[UIColor colorWithRed:174/255.0f green:174/255.0f blue:174/255.0f alpha:1]];
		[self setOperationButtonBackgroundColor:[UIColor colorWithRed:232/255.0f green:232/255.0f blue:232/255.0f alpha:1]];
		[self setOperationButtonBorderColor:[UIColor colorWithRed:174/255.0f green:174/255.0f blue:174/255.0f alpha:1]];
		...
		self.confirmButton.backgroundColor = [UIColor colorWithRed:19/255.0f green:73/255.0f blue:223/255.0f alpha:1];
		[self.confirmButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
		
		//计算帮助
		self.functionButton.titleLabel.numberOfLines = 0;
		[self.functionButton setTitle:[NSString stringWithFormat:@"计算\n帮助"] forState:UIControlStateNormal];
		self.functionButton.titleLabel.textAlignment = NSTextAlignmentCenter;
	}
	return self;
}
...
- (IBAction)userDidTapDeleteKey:(UIButton *)sender {
	[[UIDevice currentDevice] playInputClick];
	if ([self.delegate respondsToSelector:@selector(calculatorInputViewDidTapDeleteKey:)]) {
		[self.delegate calculatorInputViewDidTapDeleteKey:self];
	}
}

- (IBAction)userDidTapConfirmKey:(UIButton *)sender {
	[[UIDevice currentDevice] playInputClick];
	if ([self.delegate respondsToSelector:@selector(calculatorInputViewDidTapConfirmKey:)]) {
		[self.delegate calculatorInputViewDidTapConfirmKey:self];
	}
}
- (IBAction)userDidTapFunctionKey:(UIButton *)sender {
	[[UIDevice currentDevice] playInputClick];
	if ([self.delegate respondsToSelector:@selector(calculatorInputViewDidTapFunctionKey:)]) {
		[self.delegate calculatorInputViewDidTapFunctionKey:self];
	}
}
